...
let domainTemplate = Template(
    ...
    items: [
        ...
        .file(
            path: "Projects/Domain/\(name)DomainInterface/Sources/\(name)UseCase.swift",
            templatePath: "domain_usecase.stencil"
        ),
        .file(
            path: "Projects/Domain/\(name)DomainInterface/Sources/\(name)Repository.swift",
            templatePath: "domain_repository_interface.stencil"
        ),
        .file(
            path: "Projects/Domain/\(name)DomainTesting/Sources/\(name)UseCaseTests.swift",
        ...
        .file(
            path: "Projects/Domain/\(name)Domain/Sources/\(name)UseCaseImpl.swift",
